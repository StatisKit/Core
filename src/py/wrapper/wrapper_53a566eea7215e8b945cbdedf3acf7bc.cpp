...
::statiskit::ConditionalDistributionEstimation::explanatory_data_type const * (::statiskit::ConditionalDistributionEstimation< ::statiskit::UnivariateConditionalDistribution >::*method_pointer_a798b507f2875022ad305c6f9cef8d44)()const= &::statiskit::ConditionalDistributionEstimation< struct ::statiskit::UnivariateConditionalDistribution >::get_explanatory_data;

...
namespace autowig
{
    typedef ::statiskit::PolymorphicCopy< ::statiskit::LogisticDistribution, struct ::statiskit::ContinuousUnivariateDistribution > class_type;

    class Trampoline : public class_type
    {
        public:
            using ::statiskit::PolymorphicCopy< ::statiskit::LogisticDistribution, struct ::statiskit::ContinuousUnivariateDistribution >::PolymorphicCopy;

            typedef class ::std::unique_ptr< struct ::statiskit::UnivariateDistribution, struct ::std::default_delete< struct ::statiskit::UnivariateDistribution > >  return_type_1ba565e6e75451a89a2af6b58733c2d6;
            virtual return_type_1ba565e6e75451a89a2af6b58733c2d6 copy() const override { PYBIND11_OVERLOAD_UNIQUE_PTR(return_type_1ba565e6e75451a89a2af6b58733c2d6, class_type, copy, ); };
...
void wrapper_9819c01af16354f5af1bd00fe32e33a5(pybind11::module& module)
{
    ...
    pybind11::class_<struct ::statiskit::PolymorphicCopy< class ::statiskit::LogisticDistribution, struct ::statiskit::ContinuousUnivariateDistribution >, autowig::Trampoline, autowig::HolderType< struct ::statiskit::PolymorphicCopy< class ::statiskit::LogisticDistribution, struct ::statiskit::ContinuousUnivariateDistribution > >::Type, struct ::statiskit::ContinuousUnivariateDistribution > class_9819c01af16354f5af1bd00fe32e33a5(module, "_PolymorphicCopy_9819c01af16354f5af1bd00fe32e33a5", "");
    class_9819c01af16354f5af1bd00fe32e33a5.def(pybind11::init<  >());

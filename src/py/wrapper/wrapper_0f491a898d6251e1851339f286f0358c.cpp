...
namespace autowig
{
    ...
    class Trampoline : public class_type
    {
        public:
            ...
            typedef class ::std::unique_ptr< struct ::statiskit::MultivariateDistribution, struct ::std::default_delete< struct ::statiskit::MultivariateDistribution > >  return_type_dddd91df18fd59a6b71e5a73664a4166;
            virtual return_type_dddd91df18fd59a6b71e5a73664a4166 copy() const override { PYBIND11_OVERLOAD_UNIQUE_PTR(return_type_dddd91df18fd59a6b71e5a73664a4166, class_type, copy, ); };

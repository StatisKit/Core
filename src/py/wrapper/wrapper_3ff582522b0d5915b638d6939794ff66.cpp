...
namespace autowig
{
    typedef ::statiskit::PolymorphicCopy< ::statiskit::GeometricDistribution, struct ::statiskit::DiscreteUnivariateDistribution > class_type;

    class Trampoline : public class_type
    {
        public:
            using ::statiskit::PolymorphicCopy< ::statiskit::GeometricDistribution, struct ::statiskit::DiscreteUnivariateDistribution >::PolymorphicCopy;

            typedef class ::std::unique_ptr< struct ::statiskit::UnivariateDistribution, struct ::std::default_delete< struct ::statiskit::UnivariateDistribution > >  return_type_4579508d23c3536f82668a24b2842db4;
            virtual return_type_4579508d23c3536f82668a24b2842db4 copy() const override { PYBIND11_OVERLOAD_UNIQUE_PTR(return_type_4579508d23c3536f82668a24b2842db4, class_type, copy, ); };
...
void wrapper_3ff582522b0d5915b638d6939794ff66(pybind11::module& module)
{
    ...
    pybind11::class_<struct ::statiskit::PolymorphicCopy< class ::statiskit::GeometricDistribution, struct ::statiskit::DiscreteUnivariateDistribution >, autowig::Trampoline, autowig::HolderType< struct ::statiskit::PolymorphicCopy< class ::statiskit::GeometricDistribution, struct ::statiskit::DiscreteUnivariateDistribution > >::Type, struct ::statiskit::DiscreteUnivariateDistribution > class_3ff582522b0d5915b638d6939794ff66(module, "_PolymorphicCopy_3ff582522b0d5915b638d6939794ff66", "");
    class_3ff582522b0d5915b638d6939794ff66.def(pybind11::init<  >());

...
namespace autowig
{
    typedef ::statiskit::LogarithmicDistributionEstimation::Estimator class_type;
...
void wrapper_b08a71b7d00b57328be4226ac350fd3e(pybind11::module& module)
{
    ...
    pybind11::class_<struct ::statiskit::LogarithmicDistributionEstimation::Estimator, autowig::Trampoline, autowig::HolderType< struct ::statiskit::LogarithmicDistributionEstimation::Estimator >::Type, class ::statiskit::DiscreteUnivariateDistributionEstimation::Estimator > class_b08a71b7d00b57328be4226ac350fd3e(module, "Estimator", "");

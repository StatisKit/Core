...
namespace autowig
{
    typedef ::statiskit::BinomialDistributionEstimation::Estimator class_type;

    class Trampoline : public class_type
    {
        public:
            using ::statiskit::BinomialDistributionEstimation::Estimator::Estimator;
...
void wrapper_424fd1f865585368a48c0e974d140252(pybind11::module& module)
{
    ...
    pybind11::class_<struct ::statiskit::BinomialDistributionEstimation::Estimator, autowig::Trampoline, autowig::HolderType< struct ::statiskit::BinomialDistributionEstimation::Estimator >::Type, class ::statiskit::DiscreteUnivariateDistributionEstimation::Estimator > class_424fd1f865585368a48c0e974d140252(module, "Estimator", "");
    class_424fd1f865585368a48c0e974d140252.def(pybind11::init<  >());

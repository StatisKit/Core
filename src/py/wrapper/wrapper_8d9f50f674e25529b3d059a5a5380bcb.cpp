...
struct ::statiskit::SingularDistribution const * (::statiskit::Selection< ::statiskit::DistributionEstimation< ::statiskit::SingularDistribution > >::*method_pointer_24b830382ee05c73b073881f4f58f9f7)(::statiskit::Index const &)const= &::statiskit::Selection< class ::statiskit::DistributionEstimation< struct ::statiskit::SingularDistribution > >::get_distribution;
...
void wrapper_8d9f50f674e25529b3d059a5a5380bcb(pybind11::module& module)
{
    ...
    class_8d9f50f674e25529b3d059a5a5380bcb.def("get_distribution", method_pointer_24b830382ee05c73b073881f4f58f9f7, pybind11::return_value_policy::reference_internal, "");

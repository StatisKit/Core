...
namespace autowig
{
    typedef ::statiskit::PolymorphicCopy< ::statiskit::CauchyDistribution, struct ::statiskit::ContinuousUnivariateDistribution > class_type;

    class Trampoline : public class_type
    {
        public:
            using ::statiskit::PolymorphicCopy< ::statiskit::CauchyDistribution, struct ::statiskit::ContinuousUnivariateDistribution >::PolymorphicCopy;

            typedef class ::std::unique_ptr< struct ::statiskit::UnivariateDistribution, struct ::std::default_delete< struct ::statiskit::UnivariateDistribution > >  return_type_0408f793761c57f191af8e7422380511;
            virtual return_type_0408f793761c57f191af8e7422380511 copy() const override { PYBIND11_OVERLOAD_UNIQUE_PTR(return_type_0408f793761c57f191af8e7422380511, class_type, copy, ); };
...
void wrapper_feb9ad1a68185444ba16325ba90aea6b(pybind11::module& module)
{
    ...
    pybind11::class_<struct ::statiskit::PolymorphicCopy< class ::statiskit::CauchyDistribution, struct ::statiskit::ContinuousUnivariateDistribution >, autowig::Trampoline, autowig::HolderType< struct ::statiskit::PolymorphicCopy< class ::statiskit::CauchyDistribution, struct ::statiskit::ContinuousUnivariateDistribution > >::Type, struct ::statiskit::ContinuousUnivariateDistribution > class_feb9ad1a68185444ba16325ba90aea6b(module, "_PolymorphicCopy_feb9ad1a68185444ba16325ba90aea6b", "");
    class_feb9ad1a68185444ba16325ba90aea6b.def(pybind11::init<  >());

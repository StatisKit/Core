...
namespace autowig
{
    typedef ::statiskit::CategoricalMultivariateDistribution class_type;
...
void wrapper_c1af1f263c37571f8e1257a72f39fd05(pybind11::module& module)
{
    ...
    pybind11::class_<struct ::statiskit::CategoricalMultivariateDistribution, autowig::Trampoline, autowig::HolderType< struct ::statiskit::CategoricalMultivariateDistribution >::Type, struct ::statiskit::MultivariateDistribution > class_c1af1f263c37571f8e1257a72f39fd05(module, "CategoricalMultivariateDistribution", "");

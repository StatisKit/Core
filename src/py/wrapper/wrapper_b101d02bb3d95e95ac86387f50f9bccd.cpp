...
namespace autowig
{
    typedef ::statiskit::PolymorphicCopy< struct ::statiskit::UnivariateDistribution, ::statiskit::UnivariateHistogramDistribution, struct ::statiskit::ContinuousUnivariateDistribution > class_type;

    class Trampoline : public class_type
    {
        public:
            using ::statiskit::PolymorphicCopy< struct ::statiskit::UnivariateDistribution, ::statiskit::UnivariateHistogramDistribution, struct ::statiskit::ContinuousUnivariateDistribution >::PolymorphicCopy;
...
void wrapper_b101d02bb3d95e95ac86387f50f9bccd(pybind11::module& module)
{
    ...
    class_b101d02bb3d95e95ac86387f50f9bccd.def(pybind11::init<  >());

...
namespace autowig
{
    typedef ::statiskit::PolymorphicCopy< ::statiskit::GompertzDistribution, struct ::statiskit::ContinuousUnivariateDistribution > class_type;

    class Trampoline : public class_type
    {
        public:
            using ::statiskit::PolymorphicCopy< ::statiskit::GompertzDistribution, struct ::statiskit::ContinuousUnivariateDistribution >::PolymorphicCopy;

            typedef class ::std::unique_ptr< struct ::statiskit::UnivariateDistribution, struct ::std::default_delete< struct ::statiskit::UnivariateDistribution > >  return_type_02d924ef828a5b9da113dad49b729d1c;
            virtual return_type_02d924ef828a5b9da113dad49b729d1c copy() const override { PYBIND11_OVERLOAD_UNIQUE_PTR(return_type_02d924ef828a5b9da113dad49b729d1c, class_type, copy, ); };
...
void wrapper_6fd71629a95855bbad845fa81b27f4d5(pybind11::module& module)
{
    ...
    pybind11::class_<struct ::statiskit::PolymorphicCopy< class ::statiskit::GompertzDistribution, struct ::statiskit::ContinuousUnivariateDistribution >, autowig::Trampoline, autowig::HolderType< struct ::statiskit::PolymorphicCopy< class ::statiskit::GompertzDistribution, struct ::statiskit::ContinuousUnivariateDistribution > >::Type, struct ::statiskit::ContinuousUnivariateDistribution > class_6fd71629a95855bbad845fa81b27f4d5(module, "_PolymorphicCopy_6fd71629a95855bbad845fa81b27f4d5", "");
    class_6fd71629a95855bbad845fa81b27f4d5.def(pybind11::init<  >());

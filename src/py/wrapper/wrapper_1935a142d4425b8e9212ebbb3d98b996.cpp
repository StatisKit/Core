...
namespace autowig
{
    typedef ::statiskit::OptimizationEstimation< double, ::statiskit::NegativeBinomialDistribution, struct ::statiskit::DiscreteUnivariateDistributionEstimation >::Estimator class_type;

    class Trampoline : public class_type
    {
        public:
            using ::statiskit::OptimizationEstimation< double, ::statiskit::NegativeBinomialDistribution, struct ::statiskit::DiscreteUnivariateDistributionEstimation >::Estimator::Estimator;
...
void wrapper_1935a142d4425b8e9212ebbb3d98b996(pybind11::module& module)
{
    ...
    class_1935a142d4425b8e9212ebbb3d98b996.def(pybind11::init<  >());

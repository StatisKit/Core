...
namespace autowig
{
    typedef ::statiskit::PolymorphicCopy< ::statiskit::StudentDistribution, struct ::statiskit::ContinuousUnivariateDistribution > class_type;

    class Trampoline : public class_type
    {
        public:
            using ::statiskit::PolymorphicCopy< ::statiskit::StudentDistribution, struct ::statiskit::ContinuousUnivariateDistribution >::PolymorphicCopy;

            typedef class ::std::unique_ptr< struct ::statiskit::UnivariateDistribution, struct ::std::default_delete< struct ::statiskit::UnivariateDistribution > >  return_type_70ce27be2cd75d67a2283b08634196cb;
            virtual return_type_70ce27be2cd75d67a2283b08634196cb copy() const override { PYBIND11_OVERLOAD_UNIQUE_PTR(return_type_70ce27be2cd75d67a2283b08634196cb, class_type, copy, ); };
...
void wrapper_d9e3c8f1d16d5ffea475de8236279387(pybind11::module& module)
{
    ...
    pybind11::class_<struct ::statiskit::PolymorphicCopy< class ::statiskit::StudentDistribution, struct ::statiskit::ContinuousUnivariateDistribution >, autowig::Trampoline, autowig::HolderType< struct ::statiskit::PolymorphicCopy< class ::statiskit::StudentDistribution, struct ::statiskit::ContinuousUnivariateDistribution > >::Type, struct ::statiskit::ContinuousUnivariateDistribution > class_d9e3c8f1d16d5ffea475de8236279387(module, "_PolymorphicCopy_d9e3c8f1d16d5ffea475de8236279387", "");
    class_d9e3c8f1d16d5ffea475de8236279387.def(pybind11::init<  >());

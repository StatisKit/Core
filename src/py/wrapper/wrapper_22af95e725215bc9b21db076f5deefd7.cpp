...
::statiskit::ConditionalDistributionEstimation< struct ::statiskit::MultivariateConditionalDistribution >::explanatory_data_type const * (::statiskit::ConditionalDistributionEstimation< ::statiskit::MultivariateConditionalDistribution >::*method_pointer_46017080d9d753e2b9370e2cabcf7b67)()const= &::statiskit::ConditionalDistributionEstimation< struct ::statiskit::MultivariateConditionalDistribution >::get_explanatory_data;
...
void wrapper_22af95e725215bc9b21db076f5deefd7(pybind11::module& module)
{
    ...
    class_22af95e725215bc9b21db076f5deefd7.def(pybind11::init< ::statiskit::ConditionalDistributionEstimation< struct ::statiskit::MultivariateConditionalDistribution >::response_data_type const *, ::statiskit::ConditionalDistributionEstimation< struct ::statiskit::MultivariateConditionalDistribution >::explanatory_data_type const *, ::statiskit::ConditionalDistributionEstimation< struct ::statiskit::MultivariateConditionalDistribution >::distribution_type const * >());

...
namespace autowig
{
    ...
    class Trampoline : public class_type
    {
        public:
            ...
            typedef class ::std::unique_ptr< struct ::statiskit::MultivariateData::Generator, struct ::std::default_delete< struct ::statiskit::MultivariateData::Generator > >  return_type_8b99d3aaab095ec3909995020f652364;
            virtual return_type_8b99d3aaab095ec3909995020f652364 generator() const override { PYBIND11_OVERLOAD_UNIQUE_PTR(return_type_8b99d3aaab095ec3909995020f652364, class_type, generator, ); };

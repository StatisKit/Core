...
namespace autowig
{
    typedef ::statiskit::PolymorphicCopy< ::statiskit::PoissonDistribution, struct ::statiskit::DiscreteUnivariateDistribution > class_type;

    class Trampoline : public class_type
    {
        public:
            using ::statiskit::PolymorphicCopy< ::statiskit::PoissonDistribution, struct ::statiskit::DiscreteUnivariateDistribution >::PolymorphicCopy;

            typedef class ::std::unique_ptr< struct ::statiskit::UnivariateDistribution, struct ::std::default_delete< struct ::statiskit::UnivariateDistribution > >  return_type_e6c1575ab70f5abaa2d477d12b3ec7ff;
            virtual return_type_e6c1575ab70f5abaa2d477d12b3ec7ff copy() const override { PYBIND11_OVERLOAD_UNIQUE_PTR(return_type_e6c1575ab70f5abaa2d477d12b3ec7ff, class_type, copy, ); };
...
void wrapper_9ce76073f232512da483f80a23807ddc(pybind11::module& module)
{
    ...
    pybind11::class_<struct ::statiskit::PolymorphicCopy< class ::statiskit::PoissonDistribution, struct ::statiskit::DiscreteUnivariateDistribution >, autowig::Trampoline, autowig::HolderType< struct ::statiskit::PolymorphicCopy< class ::statiskit::PoissonDistribution, struct ::statiskit::DiscreteUnivariateDistribution > >::Type, struct ::statiskit::DiscreteUnivariateDistribution > class_9ce76073f232512da483f80a23807ddc(module, "_PolymorphicCopy_9ce76073f232512da483f80a23807ddc", "");
    class_9ce76073f232512da483f80a23807ddc.def(pybind11::init<  >());

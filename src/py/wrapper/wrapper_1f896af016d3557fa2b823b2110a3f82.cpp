...
namespace autowig
{
    typedef ::statiskit::PolymorphicCopy< ::statiskit::UniformDistribution, struct ::statiskit::ContinuousUnivariateDistribution > class_type;

    class Trampoline : public class_type
    {
        public:
            using ::statiskit::PolymorphicCopy< ::statiskit::UniformDistribution, struct ::statiskit::ContinuousUnivariateDistribution >::PolymorphicCopy;

            typedef class ::std::unique_ptr< struct ::statiskit::UnivariateDistribution, struct ::std::default_delete< struct ::statiskit::UnivariateDistribution > >  return_type_2f5adc8b114950b8893f26bc97b6abc3;
            virtual return_type_2f5adc8b114950b8893f26bc97b6abc3 copy() const override { PYBIND11_OVERLOAD_UNIQUE_PTR(return_type_2f5adc8b114950b8893f26bc97b6abc3, class_type, copy, ); };
...
void wrapper_1f896af016d3557fa2b823b2110a3f82(pybind11::module& module)
{
    ...
    pybind11::class_<struct ::statiskit::PolymorphicCopy< class ::statiskit::UniformDistribution, struct ::statiskit::ContinuousUnivariateDistribution >, autowig::Trampoline, autowig::HolderType< struct ::statiskit::PolymorphicCopy< class ::statiskit::UniformDistribution, struct ::statiskit::ContinuousUnivariateDistribution > >::Type, struct ::statiskit::ContinuousUnivariateDistribution > class_1f896af016d3557fa2b823b2110a3f82(module, "_PolymorphicCopy_1f896af016d3557fa2b823b2110a3f82", "");
    class_1f896af016d3557fa2b823b2110a3f82.def(pybind11::init<  >());

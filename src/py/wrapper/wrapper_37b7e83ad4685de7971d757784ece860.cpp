...
namespace autowig
{
    typedef ::statiskit::PolymorphicCopy< ::statiskit::UnivariateHistogramDistribution, struct ::statiskit::ContinuousUnivariateDistribution > class_type;

    class Trampoline : public class_type
    {
        public:
            using ::statiskit::PolymorphicCopy< ::statiskit::UnivariateHistogramDistribution, struct ::statiskit::ContinuousUnivariateDistribution >::PolymorphicCopy;

            typedef class ::std::unique_ptr< struct ::statiskit::UnivariateDistribution, struct ::std::default_delete< struct ::statiskit::UnivariateDistribution > >  return_type_fdde2e93ceb25cc39ecf73ee76e0cf48;
            virtual return_type_fdde2e93ceb25cc39ecf73ee76e0cf48 copy() const override { PYBIND11_OVERLOAD_UNIQUE_PTR(return_type_fdde2e93ceb25cc39ecf73ee76e0cf48, class_type, copy, ); };
...
void wrapper_37b7e83ad4685de7971d757784ece860(pybind11::module& module)
{
    ...
    pybind11::class_<struct ::statiskit::PolymorphicCopy< class ::statiskit::UnivariateHistogramDistribution, struct ::statiskit::ContinuousUnivariateDistribution >, autowig::Trampoline, autowig::HolderType< struct ::statiskit::PolymorphicCopy< class ::statiskit::UnivariateHistogramDistribution, struct ::statiskit::ContinuousUnivariateDistribution > >::Type, struct ::statiskit::ContinuousUnivariateDistribution > class_37b7e83ad4685de7971d757784ece860(module, "_PolymorphicCopy_37b7e83ad4685de7971d757784ece860", "");
    class_37b7e83ad4685de7971d757784ece860.def(pybind11::init<  >());

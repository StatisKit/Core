...
namespace autowig
{
    ...
    class Trampoline : public class_type
    {
        ...
        private:
            ...
            typedef ::statiskit::ConditionalDistributionEstimation::explanatory_data_type const & param_eb1bba57f46d5e84ae7593c48145dae1_1_type;
...
void wrapper_4637f9b5c7175ff0880fd325a6eca119(pybind11::module& module)
{
    ...
    pybind11::class_<class ::statiskit::MultivariateConditionalDistributionEstimation::Estimator, autowig::Trampoline, autowig::HolderType< class ::statiskit::MultivariateConditionalDistributionEstimation::Estimator >::Type > class_4637f9b5c7175ff0880fd325a6eca119(module, "Estimator", "");
    ...
    class_4637f9b5c7175ff0880fd325a6eca119.def("____call__", static_cast< class ::std::unique_ptr< class ::statiskit::ConditionalDistributionEstimation< struct ::statiskit::MultivariateConditionalDistribution >, struct ::std::default_delete< class ::statiskit::ConditionalDistributionEstimation< struct ::statiskit::MultivariateConditionalDistribution > > >  (::statiskit::ConditionalDistributionEstimation< ::statiskit::MultivariateConditionalDistribution >::Estimator::*) (::statiskit::ConditionalDistributionEstimation< struct ::statiskit::MultivariateConditionalDistribution >::response_data_type const &, ::statiskit::ConditionalDistributionEstimation::explanatory_data_type const &) const >(&autowig::Publicist::operator()), "");
    class_4637f9b5c7175ff0880fd325a6eca119.def("__copy", static_cast< class ::std::unique_ptr< class ::statiskit::ConditionalDistributionEstimation< struct ::statiskit::MultivariateConditionalDistribution >::Estimator, struct ::std::default_delete< class ::statiskit::ConditionalDistributionEstimation< struct ::statiskit::MultivariateConditionalDistribution >::Estimator > >  (::statiskit::ConditionalDistributionEstimation< ::statiskit::MultivariateConditionalDistribution >::Estimator::*) () const >(&autowig::Publicist::copy), "");

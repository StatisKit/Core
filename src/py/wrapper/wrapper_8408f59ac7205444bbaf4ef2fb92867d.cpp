...
namespace autowig
{
    typedef ::statiskit::PolymorphicCopy< ::statiskit::HierarchicalDistribution, struct ::statiskit::CategoricalUnivariateDistribution > class_type;

    class Trampoline : public class_type
    {
        public:
            using ::statiskit::PolymorphicCopy< ::statiskit::HierarchicalDistribution, struct ::statiskit::CategoricalUnivariateDistribution >::PolymorphicCopy;

            typedef class ::std::unique_ptr< struct ::statiskit::UnivariateDistribution, struct ::std::default_delete< struct ::statiskit::UnivariateDistribution > >  return_type_d5fbb725b4d8500ab5c0b2cf81433adc;
            virtual return_type_d5fbb725b4d8500ab5c0b2cf81433adc copy() const override { PYBIND11_OVERLOAD_UNIQUE_PTR(return_type_d5fbb725b4d8500ab5c0b2cf81433adc, class_type, copy, ); };
...
void wrapper_8408f59ac7205444bbaf4ef2fb92867d(pybind11::module& module)
{
    ...
    pybind11::class_<struct ::statiskit::PolymorphicCopy< class ::statiskit::HierarchicalDistribution, struct ::statiskit::CategoricalUnivariateDistribution >, autowig::Trampoline, autowig::HolderType< struct ::statiskit::PolymorphicCopy< class ::statiskit::HierarchicalDistribution, struct ::statiskit::CategoricalUnivariateDistribution > >::Type, struct ::statiskit::CategoricalUnivariateDistribution > class_8408f59ac7205444bbaf4ef2fb92867d(module, "_PolymorphicCopy_8408f59ac7205444bbaf4ef2fb92867d", "");
    class_8408f59ac7205444bbaf4ef2fb92867d.def(pybind11::init<  >());

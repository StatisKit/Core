...
namespace autowig
{
    typedef ::statiskit::PolymorphicCopy< ::statiskit::NegativeBinomialDistribution, struct ::statiskit::DiscreteUnivariateDistribution > class_type;

    class Trampoline : public class_type
    {
        public:
            using ::statiskit::PolymorphicCopy< ::statiskit::NegativeBinomialDistribution, struct ::statiskit::DiscreteUnivariateDistribution >::PolymorphicCopy;

            typedef class ::std::unique_ptr< struct ::statiskit::UnivariateDistribution, struct ::std::default_delete< struct ::statiskit::UnivariateDistribution > >  return_type_ffce55afea5f570493a51fd8162ce484;
            virtual return_type_ffce55afea5f570493a51fd8162ce484 copy() const override { PYBIND11_OVERLOAD_UNIQUE_PTR(return_type_ffce55afea5f570493a51fd8162ce484, class_type, copy, ); };
...
void wrapper_5266ea37de9b57c680d01c7fb2421e89(pybind11::module& module)
{
    ...
    pybind11::class_<struct ::statiskit::PolymorphicCopy< class ::statiskit::NegativeBinomialDistribution, struct ::statiskit::DiscreteUnivariateDistribution >, autowig::Trampoline, autowig::HolderType< struct ::statiskit::PolymorphicCopy< class ::statiskit::NegativeBinomialDistribution, struct ::statiskit::DiscreteUnivariateDistribution > >::Type, struct ::statiskit::DiscreteUnivariateDistribution > class_5266ea37de9b57c680d01c7fb2421e89(module, "_PolymorphicCopy_5266ea37de9b57c680d01c7fb2421e89", "");
    class_5266ea37de9b57c680d01c7fb2421e89.def(pybind11::init<  >());

...
namespace autowig
{
    typedef ::statiskit::NormalDistributionEstimation::Estimator class_type;

    class Trampoline : public class_type
    {
        public:
            using ::statiskit::NormalDistributionEstimation::Estimator::Estimator;
...
void wrapper_0017c261800c5a2ebd8adbf6d5b0d408(pybind11::module& module)
{
    ...
    pybind11::class_<struct ::statiskit::NormalDistributionEstimation::Estimator, autowig::Trampoline, autowig::HolderType< struct ::statiskit::NormalDistributionEstimation::Estimator >::Type, class ::statiskit::ContinuousUnivariateDistributionEstimation::Estimator > class_0017c261800c5a2ebd8adbf6d5b0d408(module, "Estimator", "");
    class_0017c261800c5a2ebd8adbf6d5b0d408.def(pybind11::init<  >());

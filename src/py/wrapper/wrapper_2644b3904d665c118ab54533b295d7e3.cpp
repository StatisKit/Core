...
namespace autowig
{
    typedef ::statiskit::PolymorphicCopy< struct ::statiskit::QuantitativeUnivariateFrequencyDistribution< struct ::statiskit::ContinuousUnivariateDistribution >, ::statiskit::UnivariateFrequencyDistribution< struct ::statiskit::ContinuousUnivariateDistribution > > class_type;

    class Trampoline : public class_type
    {
        public:
            using ::statiskit::PolymorphicCopy< struct ::statiskit::QuantitativeUnivariateFrequencyDistribution< struct ::statiskit::ContinuousUnivariateDistribution >, ::statiskit::UnivariateFrequencyDistribution< struct ::statiskit::ContinuousUnivariateDistribution > >::PolymorphicCopy;

            typedef class ::std::unique_ptr< struct ::statiskit::UnivariateDistribution, struct ::std::default_delete< struct ::statiskit::UnivariateDistribution > >  return_type_176a3c3dda2b546b865e07a5120aa54c;
            virtual return_type_176a3c3dda2b546b865e07a5120aa54c copy() const override { PYBIND11_OVERLOAD_UNIQUE_PTR(return_type_176a3c3dda2b546b865e07a5120aa54c, class_type, copy, ); };
...
void wrapper_2644b3904d665c118ab54533b295d7e3(pybind11::module& module)
{
    ...
    class_2644b3904d665c118ab54533b295d7e3.def(pybind11::init<  >());

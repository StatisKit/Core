...
namespace autowig
{
    typedef ::statiskit::UnivariateHistogramDistributionEstimation::Estimator class_type;

    class Trampoline : public class_type
    {
        public:
            using ::statiskit::UnivariateHistogramDistributionEstimation::Estimator::Estimator;
...
void wrapper_6fa049eb0cfd568caabaef18e2000233(pybind11::module& module)
{
    ...
    pybind11::class_<struct ::statiskit::UnivariateHistogramDistributionEstimation::Estimator, autowig::Trampoline, autowig::HolderType< struct ::statiskit::UnivariateHistogramDistributionEstimation::Estimator >::Type, class ::statiskit::ContinuousUnivariateDistributionEstimation::Estimator > class_6fa049eb0cfd568caabaef18e2000233(module, "Estimator", "");
    class_6fa049eb0cfd568caabaef18e2000233.def(pybind11::init<  >());

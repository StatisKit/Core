...
namespace autowig
{
    ...
    {
        public:
            using ::statiskit::ContinuousMultivariateDistributionEstimation::Estimator::Estimator;
...
void wrapper_9b457c1fefee52aeba68eb2ee374d6c8(pybind11::module& module)
{
    ...
    pybind11::class_<struct ::statiskit::ContinuousMultivariateDistributionEstimation::Estimator, autowig::Trampoline, autowig::HolderType< struct ::statiskit::ContinuousMultivariateDistributionEstimation::Estimator >::Type, struct ::statiskit::MultivariateDistributionEstimation::Estimator > class_9b457c1fefee52aeba68eb2ee374d6c8(module, "Estimator", "");

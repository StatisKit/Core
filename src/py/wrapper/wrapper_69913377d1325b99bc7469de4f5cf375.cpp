...
namespace autowig
{
    typedef ::statiskit::PolymorphicCopy< ::statiskit::BetaNegativeBinomialDistribution, class ::statiskit::BetaCompoundDiscreteUnivariateDistribution > class_type;

    class Trampoline : public class_type
    {
        public:
            using ::statiskit::PolymorphicCopy< ::statiskit::BetaNegativeBinomialDistribution, class ::statiskit::BetaCompoundDiscreteUnivariateDistribution >::PolymorphicCopy;

            typedef class ::std::unique_ptr< struct ::statiskit::UnivariateDistribution, struct ::std::default_delete< struct ::statiskit::UnivariateDistribution > >  return_type_5c6496bba845503082fffedd7b99c821;
            virtual return_type_5c6496bba845503082fffedd7b99c821 copy() const override { PYBIND11_OVERLOAD_UNIQUE_PTR(return_type_5c6496bba845503082fffedd7b99c821, class_type, copy, ); };
...
void wrapper_69913377d1325b99bc7469de4f5cf375(pybind11::module& module)
{
    ...
    pybind11::class_<struct ::statiskit::PolymorphicCopy< class ::statiskit::BetaNegativeBinomialDistribution, class ::statiskit::BetaCompoundDiscreteUnivariateDistribution >, autowig::Trampoline, autowig::HolderType< struct ::statiskit::PolymorphicCopy< class ::statiskit::BetaNegativeBinomialDistribution, class ::statiskit::BetaCompoundDiscreteUnivariateDistribution > >::Type, class ::statiskit::BetaCompoundDiscreteUnivariateDistribution > class_69913377d1325b99bc7469de4f5cf375(module, "_PolymorphicCopy_69913377d1325b99bc7469de4f5cf375", "");
    class_69913377d1325b99bc7469de4f5cf375.def(pybind11::init<  >());

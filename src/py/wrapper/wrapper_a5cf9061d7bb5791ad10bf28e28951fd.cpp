...
namespace autowig
{
    typedef ::statiskit::PolymorphicCopy< ::statiskit::ExponentialDistribution, struct ::statiskit::ContinuousUnivariateDistribution > class_type;

    class Trampoline : public class_type
    {
        public:
            using ::statiskit::PolymorphicCopy< ::statiskit::ExponentialDistribution, struct ::statiskit::ContinuousUnivariateDistribution >::PolymorphicCopy;

            typedef class ::std::unique_ptr< struct ::statiskit::UnivariateDistribution, struct ::std::default_delete< struct ::statiskit::UnivariateDistribution > >  return_type_e569843d13fa59ddb84b8136bd82d196;
            virtual return_type_e569843d13fa59ddb84b8136bd82d196 copy() const override { PYBIND11_OVERLOAD_UNIQUE_PTR(return_type_e569843d13fa59ddb84b8136bd82d196, class_type, copy, ); };
...
void wrapper_a5cf9061d7bb5791ad10bf28e28951fd(pybind11::module& module)
{
    ...
    pybind11::class_<struct ::statiskit::PolymorphicCopy< class ::statiskit::ExponentialDistribution, struct ::statiskit::ContinuousUnivariateDistribution >, autowig::Trampoline, autowig::HolderType< struct ::statiskit::PolymorphicCopy< class ::statiskit::ExponentialDistribution, struct ::statiskit::ContinuousUnivariateDistribution > >::Type, struct ::statiskit::ContinuousUnivariateDistribution > class_a5cf9061d7bb5791ad10bf28e28951fd(module, "_PolymorphicCopy_a5cf9061d7bb5791ad10bf28e28951fd", "");
    class_a5cf9061d7bb5791ad10bf28e28951fd.def(pybind11::init<  >());

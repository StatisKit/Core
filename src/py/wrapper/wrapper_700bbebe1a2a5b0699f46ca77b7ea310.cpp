...
namespace autowig
{
    typedef ::statiskit::PolymorphicCopy< ::statiskit::BinomialDistributionMMEstimation::Estimator, class ::statiskit::DiscreteUnivariateDistributionEstimation::Estimator > class_type;

    class Trampoline : public class_type
    {
        public:
            using ::statiskit::PolymorphicCopy< ::statiskit::BinomialDistributionMMEstimation::Estimator, class ::statiskit::DiscreteUnivariateDistributionEstimation::Estimator >::PolymorphicCopy;

            typedef class ::std::unique_ptr< class ::statiskit::DistributionEstimation< struct ::statiskit::UnivariateDistribution >::Estimator, struct ::std::default_delete< class ::statiskit::DistributionEstimation< struct ::statiskit::UnivariateDistribution >::Estimator > >  return_type_571c021b9ca953d0903ab42c3a82d413;
            virtual return_type_571c021b9ca953d0903ab42c3a82d413 copy() const override { PYBIND11_OVERLOAD_UNIQUE_PTR(return_type_571c021b9ca953d0903ab42c3a82d413, class_type, copy, ); };
...
void wrapper_700bbebe1a2a5b0699f46ca77b7ea310(pybind11::module& module)
{

    pybind11::class_<struct ::statiskit::PolymorphicCopy< class ::statiskit::BinomialDistributionMMEstimation::Estimator, class ::statiskit::DiscreteUnivariateDistributionEstimation::Estimator >, autowig::Trampoline, autowig::HolderType< struct ::statiskit::PolymorphicCopy< class ::statiskit::BinomialDistributionMMEstimation::Estimator, class ::statiskit::DiscreteUnivariateDistributionEstimation::Estimator > >::Type, class ::statiskit::DiscreteUnivariateDistributionEstimation::Estimator > class_700bbebe1a2a5b0699f46ca77b7ea310(module, "_PolymorphicCopy_700bbebe1a2a5b0699f46ca77b7ea310", "");
    class_700bbebe1a2a5b0699f46ca77b7ea310.def(pybind11::init<  >());

...
namespace autowig
{
    typedef ::statiskit::PolymorphicCopy< ::statiskit::GammaDistribution, struct ::statiskit::ContinuousUnivariateDistribution > class_type;

    class Trampoline : public class_type
    {
        public:
            using ::statiskit::PolymorphicCopy< ::statiskit::GammaDistribution, struct ::statiskit::ContinuousUnivariateDistribution >::PolymorphicCopy;

            typedef class ::std::unique_ptr< struct ::statiskit::UnivariateDistribution, struct ::std::default_delete< struct ::statiskit::UnivariateDistribution > >  return_type_f44368d0843d557aad0347d4cf452e03;
            virtual return_type_f44368d0843d557aad0347d4cf452e03 copy() const override { PYBIND11_OVERLOAD_UNIQUE_PTR(return_type_f44368d0843d557aad0347d4cf452e03, class_type, copy, ); };
...
void wrapper_0e85222f05205b5983c73610343623c8(pybind11::module& module)
{
    ...
    pybind11::class_<struct ::statiskit::PolymorphicCopy< class ::statiskit::GammaDistribution, struct ::statiskit::ContinuousUnivariateDistribution >, autowig::Trampoline, autowig::HolderType< struct ::statiskit::PolymorphicCopy< class ::statiskit::GammaDistribution, struct ::statiskit::ContinuousUnivariateDistribution > >::Type, struct ::statiskit::ContinuousUnivariateDistribution > class_0e85222f05205b5983c73610343623c8(module, "_PolymorphicCopy_0e85222f05205b5983c73610343623c8", "");
    class_0e85222f05205b5983c73610343623c8.def(pybind11::init<  >());

...
namespace autowig
{
    ...
    class Trampoline : public class_type
    {
        public:
            ...
            typedef class ::std::unique_ptr< struct ::statiskit::MultivariateDistribution, struct ::std::default_delete< struct ::statiskit::MultivariateDistribution > >  return_type_f17ecb90d14151edbab9cb55d1d60bb6;
            virtual return_type_f17ecb90d14151edbab9cb55d1d60bb6 copy() const override { PYBIND11_OVERLOAD_UNIQUE_PTR(return_type_f17ecb90d14151edbab9cb55d1d60bb6, class_type, copy, ); };

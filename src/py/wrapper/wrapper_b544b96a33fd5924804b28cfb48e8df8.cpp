...
namespace autowig
{
    typedef ::statiskit::PolymorphicCopy< ::statiskit::LaplaceDistribution, struct ::statiskit::ContinuousUnivariateDistribution > class_type;

    class Trampoline : public class_type
    {
        public:
            using ::statiskit::PolymorphicCopy< ::statiskit::LaplaceDistribution, struct ::statiskit::ContinuousUnivariateDistribution >::PolymorphicCopy;

            typedef class ::std::unique_ptr< struct ::statiskit::UnivariateDistribution, struct ::std::default_delete< struct ::statiskit::UnivariateDistribution > >  return_type_ea4f45eb12b9564bb4055f802bfda341;
            virtual return_type_ea4f45eb12b9564bb4055f802bfda341 copy() const override { PYBIND11_OVERLOAD_UNIQUE_PTR(return_type_ea4f45eb12b9564bb4055f802bfda341, class_type, copy, ); };
...
void wrapper_b544b96a33fd5924804b28cfb48e8df8(pybind11::module& module)
{
    ...
    pybind11::class_<struct ::statiskit::PolymorphicCopy< class ::statiskit::LaplaceDistribution, struct ::statiskit::ContinuousUnivariateDistribution >, autowig::Trampoline, autowig::HolderType< struct ::statiskit::PolymorphicCopy< class ::statiskit::LaplaceDistribution, struct ::statiskit::ContinuousUnivariateDistribution > >::Type, struct ::statiskit::ContinuousUnivariateDistribution > class_b544b96a33fd5924804b28cfb48e8df8(module, "_PolymorphicCopy_b544b96a33fd5924804b28cfb48e8df8", "");
    class_b544b96a33fd5924804b28cfb48e8df8.def(pybind11::init<  >());

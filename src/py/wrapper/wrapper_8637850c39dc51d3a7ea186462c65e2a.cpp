...
namespace autowig
{
    ...
    class Trampoline : public class_type
    {
        public:
            ...
            typedef class ::std::unique_ptr< class ::statiskit::DistributionEstimation< struct ::statiskit::UnivariateDistribution >::Estimator, struct ::std::default_delete< class ::statiskit::DistributionEstimation< struct ::statiskit::UnivariateDistribution >::Estimator > >  return_type_cdd36c187228509e9e1dd6d09970aa6e;
            virtual return_type_cdd36c187228509e9e1dd6d09970aa6e copy() const override { PYBIND11_OVERLOAD_UNIQUE_PTR(return_type_cdd36c187228509e9e1dd6d09970aa6e, class_type, copy, ); };

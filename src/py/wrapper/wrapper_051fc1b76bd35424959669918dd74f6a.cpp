...
namespace autowig
{
    ...
    class Trampoline : public class_type
    {
        public:
            ...
            typedef class ::std::unique_ptr< class ::statiskit::DistributionEstimation< struct ::statiskit::UnivariateDistribution >::Estimator, struct ::std::default_delete< class ::statiskit::DistributionEstimation< struct ::statiskit::UnivariateDistribution >::Estimator > >  return_type_ecf411e8b806576fa89996140a008799;
            virtual return_type_ecf411e8b806576fa89996140a008799 copy() const override { PYBIND11_OVERLOAD_UNIQUE_PTR(return_type_ecf411e8b806576fa89996140a008799, class_type, copy, ); };

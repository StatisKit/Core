...
namespace autowig
{
    ...
    class Trampoline : public class_type
    {
        public:
            ...
            typedef class ::std::unique_ptr< class ::statiskit::DistributionEstimation< struct ::statiskit::UnivariateDistribution >::Estimator, struct ::std::default_delete< class ::statiskit::DistributionEstimation< struct ::statiskit::UnivariateDistribution >::Estimator > >  return_type_f6490a0c561e5b4fb5fbd58a16a162fe;
            virtual return_type_f6490a0c561e5b4fb5fbd58a16a162fe copy() const override { PYBIND11_OVERLOAD_UNIQUE_PTR(return_type_f6490a0c561e5b4fb5fbd58a16a162fe, class_type, copy, ); };

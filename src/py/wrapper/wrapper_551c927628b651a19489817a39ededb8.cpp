...
namespace autowig
{
    ...
    class Trampoline : public class_type
    {
        public:
            ...
            typedef class ::std::unique_ptr< struct ::statiskit::UnivariateDistribution, struct ::std::default_delete< struct ::statiskit::UnivariateDistribution > >  return_type_a205addf42fc5a04a93a767ffca67641;
            virtual return_type_a205addf42fc5a04a93a767ffca67641 copy() const override { PYBIND11_OVERLOAD_UNIQUE_PTR(return_type_a205addf42fc5a04a93a767ffca67641, class_type, copy, ); };

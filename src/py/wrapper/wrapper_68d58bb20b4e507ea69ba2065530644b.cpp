...
namespace autowig
{
    typedef ::statiskit::PolymorphicCopy< ::statiskit::BetaDistribution, struct ::statiskit::ContinuousUnivariateDistribution > class_type;

    class Trampoline : public class_type
    {
        public:
            using ::statiskit::PolymorphicCopy< ::statiskit::BetaDistribution, struct ::statiskit::ContinuousUnivariateDistribution >::PolymorphicCopy;

            typedef class ::std::unique_ptr< struct ::statiskit::UnivariateDistribution, struct ::std::default_delete< struct ::statiskit::UnivariateDistribution > >  return_type_9e2743a59905503485961e2a474a8e16;
            virtual return_type_9e2743a59905503485961e2a474a8e16 copy() const override { PYBIND11_OVERLOAD_UNIQUE_PTR(return_type_9e2743a59905503485961e2a474a8e16, class_type, copy, ); };
...
void wrapper_68d58bb20b4e507ea69ba2065530644b(pybind11::module& module)
{
    ...
    pybind11::class_<struct ::statiskit::PolymorphicCopy< class ::statiskit::BetaDistribution, struct ::statiskit::ContinuousUnivariateDistribution >, autowig::Trampoline, autowig::HolderType< struct ::statiskit::PolymorphicCopy< class ::statiskit::BetaDistribution, struct ::statiskit::ContinuousUnivariateDistribution > >::Type, struct ::statiskit::ContinuousUnivariateDistribution > class_68d58bb20b4e507ea69ba2065530644b(module, "_PolymorphicCopy_68d58bb20b4e507ea69ba2065530644b", "");
    class_68d58bb20b4e507ea69ba2065530644b.def(pybind11::init<  >());

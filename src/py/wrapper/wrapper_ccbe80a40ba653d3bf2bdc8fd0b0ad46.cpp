...
void wrapper_ccbe80a40ba653d3bf2bdc8fd0b0ad46(pybind11::module& module)
{
    ...
    pybind11::class_<struct ::statiskit::DiscreteUnivariateConditionalDistributionEstimation::Estimator, autowig::Trampoline, autowig::HolderType< struct ::statiskit::DiscreteUnivariateConditionalDistributionEstimation::Estimator >::Type, struct ::statiskit::UnivariateConditionalDistributionEstimation::Estimator > class_ccbe80a40ba653d3bf2bdc8fd0b0ad46(module, "Estimator", "");

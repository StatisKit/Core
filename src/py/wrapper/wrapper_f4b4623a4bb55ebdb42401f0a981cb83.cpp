...
namespace autowig
{
    typedef ::statiskit::PolymorphicCopy< ::statiskit::GumbelDistribution, struct ::statiskit::ContinuousUnivariateDistribution > class_type;

    class Trampoline : public class_type
    {
        public:
            using ::statiskit::PolymorphicCopy< ::statiskit::GumbelDistribution, struct ::statiskit::ContinuousUnivariateDistribution >::PolymorphicCopy;

            typedef class ::std::unique_ptr< struct ::statiskit::UnivariateDistribution, struct ::std::default_delete< struct ::statiskit::UnivariateDistribution > >  return_type_e3498b10e5415f52b2480b5a9a098ccf;
            virtual return_type_e3498b10e5415f52b2480b5a9a098ccf copy() const override { PYBIND11_OVERLOAD_UNIQUE_PTR(return_type_e3498b10e5415f52b2480b5a9a098ccf, class_type, copy, ); };
...
void wrapper_f4b4623a4bb55ebdb42401f0a981cb83(pybind11::module& module)
{
    ...
    pybind11::class_<struct ::statiskit::PolymorphicCopy< class ::statiskit::GumbelDistribution, struct ::statiskit::ContinuousUnivariateDistribution >, autowig::Trampoline, autowig::HolderType< struct ::statiskit::PolymorphicCopy< class ::statiskit::GumbelDistribution, struct ::statiskit::ContinuousUnivariateDistribution > >::Type, struct ::statiskit::ContinuousUnivariateDistribution > class_f4b4623a4bb55ebdb42401f0a981cb83(module, "_PolymorphicCopy_f4b4623a4bb55ebdb42401f0a981cb83", "");
    class_f4b4623a4bb55ebdb42401f0a981cb83.def(pybind11::init<  >());

...
namespace autowig
{
    typedef ::statiskit::PoissonDistributionEstimation::Estimator class_type;

    class Trampoline : public class_type
    {
        public:
            using ::statiskit::PoissonDistributionEstimation::Estimator::Estimator;
...
void wrapper_e48db52757bf5acbabe40fda3e8fafb6(pybind11::module& module)
{
    ...
    pybind11::class_<struct ::statiskit::PoissonDistributionEstimation::Estimator, autowig::Trampoline, autowig::HolderType< struct ::statiskit::PoissonDistributionEstimation::Estimator >::Type, class ::statiskit::DiscreteUnivariateDistributionEstimation::Estimator > class_e48db52757bf5acbabe40fda3e8fafb6(module, "Estimator", "");
    class_e48db52757bf5acbabe40fda3e8fafb6.def(pybind11::init<  >());

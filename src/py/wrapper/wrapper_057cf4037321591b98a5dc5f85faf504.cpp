...
class ::std::unique_ptr< class ::statiskit::DistributionEstimation< struct ::statiskit::MultivariateDistribution >, struct ::std::default_delete< class ::statiskit::DistributionEstimation< struct ::statiskit::MultivariateDistribution > > >  (::statiskit::DistributionEstimation< ::statiskit::MultivariateDistribution >::Estimator::*method_pointer_171594468546584aa9e0715c04238dd6)(struct ::statiskit::MultivariateData const &, class ::std::set< unsigned long int, struct ::std::less< unsigned long int >, class ::std::allocator< unsigned long int > > const &)const= &::statiskit::DistributionEstimation< struct ::statiskit::MultivariateDistribution >::Estimator::operator();
...
void wrapper_057cf4037321591b98a5dc5f85faf504(pybind11::module& module)
{
    ...
    class_057cf4037321591b98a5dc5f85faf504.def("__call__", method_pointer_171594468546584aa9e0715c04238dd6, "");

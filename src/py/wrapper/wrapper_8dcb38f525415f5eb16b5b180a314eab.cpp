...
namespace autowig
{
    ...
    class Trampoline : public class_type
    {
        ...
        private:
            ...
            typedef ::statiskit::ConditionalDistributionEstimation::explanatory_data_type const & param_d18d2511347f5c78ba04fd10700b87ec_1_type;
...
void wrapper_8dcb38f525415f5eb16b5b180a314eab(pybind11::module& module)
{
    ...
    pybind11::class_<class ::statiskit::UnivariateConditionalDistributionEstimation::Estimator, autowig::Trampoline, autowig::HolderType< class ::statiskit::UnivariateConditionalDistributionEstimation::Estimator >::Type > class_8dcb38f525415f5eb16b5b180a314eab(module, "Estimator", "");

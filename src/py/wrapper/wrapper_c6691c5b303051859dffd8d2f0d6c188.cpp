...
namespace autowig
{
    ...
    class Trampoline : public class_type
    {
        public:
            ...
            typedef class ::std::unique_ptr< class ::statiskit::DistributionEstimation< struct ::statiskit::MultivariateDistribution >::Estimator, struct ::std::default_delete< class ::statiskit::DistributionEstimation< struct ::statiskit::MultivariateDistribution >::Estimator > >  return_type_ba7a0ab873c65a578155a29bb2499a13;
            virtual return_type_ba7a0ab873c65a578155a29bb2499a13 copy() const override { PYBIND11_OVERLOAD_UNIQUE_PTR(return_type_ba7a0ab873c65a578155a29bb2499a13, class_type, copy, ); };
